...
Table 4 gives example data used to construct dose-effect curves for low LET $\gamma$-radiation and high LET $\alpha$ radiation.
...
knitr::kable(mytable, booktabs = TRUE, caption = "[Download dicentrics distribution.](https://biodosimetry-uab.github.io/documentation/data/count-data-IAEA.csv)")
```
...
The $p$-values of the $\chi^{2}$-test shown in Table 5 indicate that the fitted data points were not statistically different from the observed ones confirming a good fit.
