...
mytable %>% 
  knitr::kable(booktabs = TRUE, 
               caption = "[Download dicentrics distribution.](https://biodosimetry-uab.github.io/documentation/data/count-data-IAEA.csv)") #%>% 
