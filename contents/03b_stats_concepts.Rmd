...
Since most curve fitting methods are based on Poisson statistics, the dicentric cell distribution should be tested for compliance with the Poisson distribution for each dose used to construct the calibration curve. Nowadays, the most widely used test is the $u$-test [@Rao1956; 100]. The $u$-test statistic is a normalized unit of the dispersion index ($\sigma^{2}/\bar{y}$), which for a Poisson distribution should be unity. $u$-values higher than 1.96 indicate overdispersion (with a two-sided significance level, $\alpha$ = 0.025).
