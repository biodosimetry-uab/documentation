...
Another approach for whole-body assessment is using the delta method \citepalias{IAEA2001}. It also allows both the Poisson error on the yield and the errors on the calibration curve to be taken into account.
