...
{\centering \includegraphics[width=0.8\linewidth]{biodose-tools_files/figure-latex/nice-fig-1} 
...
\begin{Highlighting}[]
\CommentTok{%-----------------------------------------------------------------}
\CommentTok{%   MATHS AND SCIENCE}
\CommentTok{%-----------------------------------------------------------------}
\BuiltInTok{\textbackslash{}usepackage}\NormalTok{\{}\ExtensionTok{amsmath,amsfonts,amsthm,amssymb}\NormalTok{\}}
\BuiltInTok{\textbackslash{}usepackage}\NormalTok{\{}\ExtensionTok{xfrac}\NormalTok{\}}
\BuiltInTok{\textbackslash{}usepackage}\NormalTok{[a]\{}\ExtensionTok{esvect}\NormalTok{\}}
\BuiltInTok{\textbackslash{}usepackage}\NormalTok{\{}\ExtensionTok{chemformula}\NormalTok{\}}
...
\chapter{Appendix A: Black Magic}\label{appendix-a-black-magic}}
